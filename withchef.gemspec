...
Gem::Specification.new do |s|
  ...
  s.homepage      = 'https://localhost.local/withchef'
  ...
  # s.files         = ['']
  s.require_paths = ['lib/selfbootstrap/withchef']
  # s.executables   = all_files.grep(%r!^exe/!) { |f| File.basename(f) }
  # s.bindir        = 'exe'

  s.metadata      = {
    # 'source_code_uri' => '/home/git/withchef.git/',
    'bug_tracker_uri' => 'https://localhost.local/withchef/issues',
    'changelog_uri'   => 'https://localhost.local/withchef/releases',
  ...
  s.add_runtime_dependency('nochef', '~> 0.1')
