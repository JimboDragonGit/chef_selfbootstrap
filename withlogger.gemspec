...
Gem::Specification.new do |s|
  ...
  s.homepage      = 'https://localhost.local/withlogger'
  ...
  # s.files         = ['']
  s.require_paths = ['lib/selfbootstrap/withlogger']
  # s.executables   = all_files.grep(%r!^exe/!) { |f| File.basename(f) }
  # s.bindir        = 'exe'

  s.metadata      = {
    # 'source_code_uri' => '/home/git/withlogger.git/',
    'bug_tracker_uri' => 'https://localhost.local/withlogger/issues',
    'changelog_uri'   => 'https://localhost.local/withlogger/releases',
  ...
  s.add_runtime_dependency('withchef', '~> 0.1')
